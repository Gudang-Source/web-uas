		...
		<div class="col-xs-12">
			...
			<div class="card">
				...
				<div class="body">
					...
					<?php echo form_open_multipart('admin/user/edit/'.$user->id); ?>
						...
						<div class="form-group form-float">
							...
							<div class="form-line <?php echo ($field_error) ? 'error' : ''; ?>">
								<input class="form-control" name="<?php echo $field_name; ?>" type="text" value="<?php echo set_value($field_name, $user->$field_name); ?>">
						...
						<div class="form-group form-float">
							...
							<?php $field_label = 'Password (Kosongkan jika tidak ingin diganti)'; ?>
							<?php $field_error = form_error($field_name); ?>
							<div class="form-line <?php echo ($field_error) ? 'error' : ''; ?>">
						...
						<div class="form-group form-float">
							...
							<?php $field_label = 'Ulangi Password (Kosongkan jika tidak ingin diganti)'; ?>
							<?php $field_error = form_error($field_name); ?>
							<div class="form-line <?php echo ($field_error) ? 'error' : ''; ?>">
								<input class="form-control" name="<?php echo $field_name; ?>" type="password" value="<?php echo set_value($field_name); ?>">
								<label class="form-label"><?php echo $field_label; ?></label>
						...
						<div class="form-group form-float">
							...
							<?php $field_error = form_error($field_name); ?>
							<div class="form-line <?php echo ($field_error) ? 'error' : ''; ?>">
								<input class="form-control" name="<?php echo $field_name; ?>" type="email" value="<?php echo set_value($field_name, $user->$field_name); ?>">
								<label class="form-label"><?php echo $field_label; ?></label>
							</div>
							<?php if($field_error): ?>
								<label class="error" for="<?php echo $field_name; ?>"><?php echo $field_error; ?></label>
							...
							<div class="form-line <?php echo ($field_error) ? 'error' : ''; ?>">
								<select name="<?php echo $field_name; ?>" class="form-control show-tick">
									...
									<?php if(!empty($roles)): foreach($roles as $role): ?>
										<option value="<?php echo $role['id_role']; ?>" <?php selected($role['id_role'], set_value($field_name, $user->id_role)); ?>><?php echo $role['nama_role']; ?></option>
						...
						<div class="form-group form-float">
							...
							<div class="<?php echo ($field_error) ? 'error' : ''; ?>">
								...
								<?php if($user->foto): ?>
									<img src="<?php echo base_url('uploads/'.$user->foto); ?>" width="230" class="img-responsive thumbnail" alt="User Foto">
								<?php endif; ?>
