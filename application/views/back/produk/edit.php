...
<div class="container-fluid">
	...
	<div class="row clearfix">	
		...
		<div class="col-xs-12">
			...
			<?php echo form_open_multipart('admin/produk/edit/'.$produk->id); ?>
			<div class="row clearfix">
						...
						<div class="body">	
							...
							<div class="form-group form-float">
								...
								<div class="form-line <?php echo ($field_error) ? 'error' : ''; ?>">
									<input class="form-control" name="<?php echo $field_name; ?>" type="text" value="<?php echo set_value($field_name, $produk->$field_name); ?>">
							...
							<div class="form-group">
								...
								<div class="<?php echo ($field_error) ? 'error' : ''; ?>">
									<label class="form-label"><?php echo $field_label; ?></label>
									<textarea id="tinymce" name="<?php echo $field_name; ?>"><?php echo set_value($field_name, $produk->$field_name); ?></textarea>
								</div>
								<?php if($field_error): ?>
									<label class="error" for="<?php echo $field_name; ?>"><?php echo $field_error; ?></label>
								<?php endif; ?>
							...
							<div class="form-group form-float">
								...
								<?php $field_error = form_error($field_name); ?>
								<div class="form-line <?php echo ($field_error) ? 'error' : ''; ?>">
									<input class="form-control" name="<?php echo $field_name; ?>" type="number" value="<?php echo set_value($field_name, $produk->$field_name); ?>">
									<label class="form-label"><?php echo $field_label; ?></label>
								</div>
								<?php if($field_error): ?>
									<label class="error" for="<?php echo $field_name; ?>"><?php echo $field_error; ?></label>
							...
							<button type="submit" class="btn btn-primary waves-effect"><i class="material-icons">check</i><span>SIMPAN</span></button>
							<a href="<?php echo site_url('admin/produk'); ?>" class="btn bg-blue-grey waves-effect"><i class="material-icons">cancel</i><span>BATAL</span></a>
					...
					<div class="card">
						...
						<div class="body">							
							...
							<div class="form-group">
								...
								<?php $field_error = form_error($field_name); ?>
								<?php $original_value = explode(',', $produk->id_cats); ?>
								<?php $reserved_values = set_value($field_name, $original_value); ?>
								<div class="<?php echo ($field_error) ? 'error' : ''; ?>">
									<label class="form-label"><?php echo $field_label; ?></label>
